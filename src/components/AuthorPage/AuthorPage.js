    ...
    return (
        <div className="blog-page-component">
            <div className="heading">
                ...
                <div className="right">
                    <div className="autore">
                        <h1>Ludovico Besana</h1><span>  |  </span><span>Founder</span>
                    </div>
                    <p>
                        Software Tester & Full Stack Developer<br />
            ...
            <div className="i-miei-articoli">
                ...
                <a href="#" target="_blank" className="vedi-tutti">Vedi altri articoli</a>
            </div>
