...
const Blog = () => {
	...
	newArgomenti.forEach(treArgomenti => {
		definitiveArgomenti.push(
			<Row>
				<Col>{treArgomenti[0]}</Col>
				<Col>{treArgomenti[1]}</Col>
				<Col>{treArgomenti[2]}</Col>
			</Row>,
		)
	})
				...
				<Row>
					<Col>
						...
						<div className={blog.description}>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse quis sodales
							felis. Sed ut orci tellus. Nullam finibus dui arcu, quis hendrerit leo auctor sit
							amet. Quisque ultrices finibus sapien sed sagittis. Nam nec cursus erat, ut suscipit
							dolor. Etiam fringilla venenatis metus id suscipit. Maecenas ut leo sed urna iaculis
							ullamcorper at fringilla dui.
						</div>
