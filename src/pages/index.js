	...
	return (
		<Layout>
			<TextAndPhoto
				...
				title={query.datoCmsHomepage.sections[5].titolo}
			...
			/>
			<Aziende
				title={query.datoCmsHomepage.sections[8].titolo}
				description={query.datoCmsHomepage.sections[8].descrizione}
				partners={partners}
			/>
			<Progetti
				title={query.datoCmsHomepage.sections[2].titolo}
				projects={projects}
				link={query.datoCmsHomepage.sections[2].linkPaginaProgetti}
			/>
			<WhyEnter
				title={query.datoCmsHomepage.sections[9].titolo}
				description={query.datoCmsHomepage.sections[9].descrizione}
				img={query.datoCmsHomepage.sections[9].immagine.url}
			/>
			<EntraOraHome
				discord_img={query.datoCmsHomepage.sections[1].immagineDiscord.url}
				description={query.datoCmsHomepage.sections[1].descrizione}
				background_img={query.datoCmsHomepage.sections[1].immagineBackground.url}
			...
			<DiconoDiNoi
				...
				reviews={reviews}
				title={query.datoCmsHomepage.sections[7].titolo}
			/>
		</Layout>
	)
}
